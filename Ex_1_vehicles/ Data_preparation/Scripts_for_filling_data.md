# Scripts for Filling Data

В этом файле собраны SQL-скрипты для заполнения таблиц базы данных тестовыми данными.

## 1. Заполнение таблицы `Vehicle`
...
## 3. Заполнение таблицы `Motorcycle`
